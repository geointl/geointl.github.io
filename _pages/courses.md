...
permalink: /courses/
title: Courses
# description: Course materials and self-paced learning modules.
nav: true
nav_order: 5
---

Course materials and self-paced learning modules for geotechnical computing, data science, and research software development.

## CEE-8813-H: Numerical Modeling and Data Science for Geotechnics
...
[<i class="fa-brands fa-github fa-sm"></i> Repository](https://github.com/yjchoi1/fem-geotech-tutorial){:target="_blank"}
...
[<i class="fa-brands fa-github fa-sm"></i> Repository](https://github.com/yjchoi1/ml-tutorial-classification){:target="_blank"}

## Basics of DevOps for Engineers
...
[<i class="fa-solid fa-book-open fa-sm"></i> Get started](https://yjchoi1.github.io/devops-basics-engineers/){:target="_blank"}

## Others

### Quick tutorial for C++

[<i class="fa-brands fa-github fa-sm"></i> Repository](https://github.com/yjchoi1/cpp){:target="_blank"}

### Containers and docker for machine learning projects

[<i class="fa-brands fa-docker fa-sm"></i> Module](https://github.com/yjchoi1/devops-basics-engineers/tree/main/docs/04-container-and-docker){:target="_blank"}
