...
tags: uncertainty-quantification graph-neural-networks physics-informed-machine-learning
---
...
> {% cite choi2026accelerating %}


<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/rgns-reliability.png" title="rngs reliability" class="img-fluid rounded" %}
    </div>
</div>
<div class="caption">
